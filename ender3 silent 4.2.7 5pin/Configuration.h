...
#define STRING_CONFIG_H_AUTHOR "(DiyProJames, Ender-3)" // Who made the changes. Configuration 4 Ender 3, bltouch v3.1, MicroSwiss DD & Hotend
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -43, -7, -5 }
